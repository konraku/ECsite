    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      ...
      <div class=" -m-2">
        ...
        <div class="p-2 w-full flex justify-around mt-4 mb-8">
          ...
          <button type="submit" onclick="location.href" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">create</button>
        </div>
      </div>
    </form>
    </div>
